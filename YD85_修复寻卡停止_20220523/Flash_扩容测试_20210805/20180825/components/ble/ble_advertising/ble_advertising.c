...
//    adv_params.p_whitelist = NULL;
//		
    adv_params.channel_mask.ch_37_off = 0;    //设置37频道是否广播
   adv_params.channel_mask.ch_38_off =  0;  //设置38频道是否广播
   adv_params.channel_mask.ch_39_off =  0;  //设置39频道是否广播
...
//    uint32_t             count = 0;
		...
		adv_params.channel_mask.ch_37_off = 1;    //设置37频道是否广播
   adv_params.channel_mask.ch_38_off =  1;  //设置38频道是否广播
   adv_params.channel_mask.ch_39_off =  1;  //设置39频道是否广播
