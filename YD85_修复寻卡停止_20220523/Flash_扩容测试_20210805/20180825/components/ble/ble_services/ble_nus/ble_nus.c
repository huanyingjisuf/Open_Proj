...
#define NUS_BASE_UUID                    {{ 0x77, 0xE4, 0x05, 0xD2, 0xAF, 0x9F, 0xA9, 0x8F, 0xE5, 0x4A, 0x7D, 0xFE, 0x43, 0x53, 0x53, 0x49}} /**< Used vendor specific UUID. */
#define NUS_BASE_UUID2                   {{ 0x77, 0x9B, 0x72, 0x34, 0xBE, 0xEC, 0xD4, 0xA8, 0xF4, 0x43, 0x41, 0x88, 0x43, 0x53, 0x53, 0x49}} /**< Used vendor specific UUID. */
#define NUS_BASE_UUID1                   {{ 0x77, 0x96, 0x24, 0x47, 0xC6, 0x23, 0x61, 0xBA, 0xD9, 0x4B, 0x4D, 0x1E, 0x43, 0x53, 0x53, 0x49}} /**< Used vendor specific UUID. */
 ...
 * @param[in] p_ble_evt Pointer to the event received from BLE stack.//从BLE栈收到的事件指针
 */
...
uint32_t ble_nus_init(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
    ...
    // Initialize the service structure.  //初始化服务结构
    p_nus->conn_handle             = BLE_CONN_HANDLE_INVALID;
    p_nus->data_handler            = p_nus_init->data_handler;
    p_nus->is_notification_enabled = false;

    /**@snippet [Adding proprietary Service to S110 SoftDevice] */
    // Add a custom base UUID.  //载入自定义基地址
